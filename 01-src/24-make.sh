...
echo "cloning repo"
git clone https://github.com/qunixorg/make.git || { echo "can not fetch repository, please check logs installation aborted" ; exit 1; }
...
./configure --prefix=/tools --without-guile || { echo "can not configure project, please check logs installation aborted" ; exit 1; }
