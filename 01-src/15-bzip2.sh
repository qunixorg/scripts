...
echo "cloning repo"
git clone https://github.com/qunixorg/bzip2.git || { echo "can not fetch repository, please check logs installation aborted" ; exit 1; }
...
time make -s PREFIX=/tools install > install.log || { echo "can not install, please check logs installation aborted" ; exit 1; }
