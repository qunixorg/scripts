...
echo "cloning repo"
git clone https://github.com/qunixorg/diffutils.git || { echo "can not fetch repository, please check logs installation aborted" ; exit 1; }
...
CFLAGS="-Wno-error" ./configure --prefix=/tools || { echo "can not configure project, please check logs installation aborted" ; exit 1; }
