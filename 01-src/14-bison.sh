...
echo "cloning repo"
git clone https://github.com/qunixorg/bison.git || { echo "can not fetch repository, please check logs installation aborted" ; exit 1; }
...
./bootstrap --no-git || { echo "can not run bootstrap, please check logs installation aborted" ; exit 1; }
